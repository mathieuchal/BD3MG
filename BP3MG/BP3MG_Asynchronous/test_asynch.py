...
from BP3MG.BP3MG_Asynchronous.APAR3MG_MPI import APAR3MG_MPI
...
ratio = {}
SNR = {}
BD3MG = APAR3MG_MPI(y, h, Hty, H1, eta, tau, lambda_, delta, xmin, xmax, phi, x0, I, Nx, Ny, Nz,NbIt, Timemax, epsilon=1e-5, cores_number=0, setting=None)
BD3MG.optimize()
